...
package com.micda.pfe.eboutique.config;
...
//			.withUser(users.username("youssef").password("test123").roles("EMPLOYEE"))
//			.withUser(users.username("ossama").password("test123").roles("EMPLOYEE", "CLIENT"))
//			.withUser(users.username("test").password("test123").roles("EMPLOYEE", "ADMIN"));
//	}
	...
	*/
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		//
		// CLIENT role can perform following 
		...
		http.authorizeRequests()
		.antMatchers(HttpMethod.GET, "/api").hasAnyRole("CLIENT", "ADMIN")
		.antMatchers(HttpMethod.GET, "/api/**").hasAnyRole("CLIENT", "ADMIN")
		.antMatchers(HttpMethod.POST, "/api/").hasAnyRole("CLIENT", "ADMIN")
		.antMatchers(HttpMethod.POST, "/api/**").hasAnyRole("CLIENT", "ADMIN")
		.antMatchers(HttpMethod.PUT, "/api/").hasAnyRole("CLIENT", "ADMIN")
		.antMatchers(HttpMethod.PUT, "/api/**").hasAnyRole("CLIENT", "ADMIN")
